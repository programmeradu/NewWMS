...
const AccountNavBar = () => {
  ...
  return (
    <AppBar
      position="static"
      sx={{ color: "black", backgroundColor: "transparent", boxShadow: "none" }}
    >
      <Container
        maxWidth="xl"
      ...
      >
        ...
        >
          ...
          <Box
            ...
            sx={{ backgroundSize: "cover", height: 48 }}
          />
          <Button
            sx={{ p: 2, m: 3, backgroundColor: "black" }}
            variant="contained"
            onClick={() => navigateTo("/newPickUp")}
          >
            New PickUp
          </Button>
